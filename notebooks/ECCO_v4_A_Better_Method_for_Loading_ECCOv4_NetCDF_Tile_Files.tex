...
{\color{incolor}In [{\color{incolor}1}]:} \PY{k+kn}{import} \PY{n+nn}{matplotlib.pylab} \PY{k+kn}{as} \PY{n+nn}{plt}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{} point to your local directory holding the nctiles\PYZus{}grid files}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{n}{grid\PYZus{}3\PYZus{}od}
\end{Verbatim}
...
\texttt{grid\_3\_new}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{var} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{GRID}\PY{l+s+s1}{\PYZsq{}}
...
loading /Volumes/ECCO\_BASE/ECCO\_v4r3/nctiles\_grid/GRID.0003.nc
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{n}{grid\PYZus{}3\PYZus{}new}
\end{Verbatim}
...
\texttt{load\_tile\_from\_netcdf} routine:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{grid\PYZus{}3\PYZus{}new}\PY{o}{.}\PY{n}{XC}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}6}]:} <xarray.DataArray 'XC' (j: 90, i: 90)>
...
Let's load tile 3 of the 'c' point sea surface height (SSH) variable.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{data\PYZus{}dir}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/Volumes/ECCO\PYZus{}BASE/ECCO\PYZus{}v4r3/nctiles\PYZus{}monthly/SSH/}\PY{l+s+s1}{\PYZsq{}}    
...
state estimate let's closely examine \texttt{ssh\_tile\_3}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{ssh\PYZus{}tile\PYZus{}3}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}8}]:} <xarray.Dataset>
...
\texttt{DataArary}:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{ssh\PYZus{}tile\PYZus{}3}\PY{o}{.}\PY{n}{SSH}
\end{Verbatim}
...
coordinates}\label{the-time-non-dimensional-coordinates}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{n}{ssh\PYZus{}tile\PYZus{}3}\PY{o}{.}\PY{n}{time}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}10}]:} <xarray.DataArray 'time' (time: 288)>
...
the longitude and latitude for each of the 'c' points of \(SSH\).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{ssh\PYZus{}tile\PYZus{}3}\PY{o}{.}\PY{n}{lon\PYZus{}c}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}11}]:} <xarray.DataArray 'lon\_c' (j: 90, i: 90)>
         array([[-37.5     , -36.5     , -35.5     , {\ldots},  49.5     ,  50.5     ,  51.5     ],
                [-37.5     , -36.5     , -35.5     , {\ldots},  49.5     ,  50.5     ,  51.5     ],
                [-37.5     , -36.5     , -35.5     , {\ldots},  49.5     ,  50.5     ,  51.5     ],
                {\ldots}, 
...
\(x\) direction variable, \(UVEL\).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{data\PYZus{}dir}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/Volumes/ECCO\PYZus{}BASE/ECCO\PYZus{}v4r3/nctiles\PYZus{}monthly/UVEL/}\PY{l+s+s1}{\PYZsq{}}    
...
number of times.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{n}{ecco}\PY{o}{.}\PY{n}{minimal\PYZus{}metadata}\PY{p}{(}\PY{n}{uvel\PYZus{}tile\PYZus{}3}\PY{p}{)}
\end{Verbatim}
...
Removing Dataset Attributes A-Z
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{n}{uvel\PYZus{}tile\PYZus{}3}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}14}]:} <xarray.Dataset>
...
take a look at the \(UVEL\) \texttt{DataArary}:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{uvel\PYZus{}tile\PYZus{}3}\PY{o}{.}\PY{n}{UVEL}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}15}]:} <xarray.DataArray 'UVEL' (time: 288, tile: 1, k: 50, j: 90, i\_g: 90)>
...
meters:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{n}{uvel\PYZus{}tile\PYZus{}3}\PY{o}{.}\PY{n}{dep}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}16}]:} <xarray.DataArray 'dep' (k: 50)>
...
\(x\) direction variable, \(VVEL\).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{n}{data\PYZus{}dir}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/Volumes/ECCO\PYZus{}BASE/ECCO\PYZus{}v4r3/nctiles\PYZus{}monthly/VVEL/}\PY{l+s+s1}{\PYZsq{}}    
...
Removing Dataset Attributes A-Z
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{n}{vvel\PYZus{}tile\PYZus{}3}\PY{o}{.}\PY{n}{coords}
\end{Verbatim}
